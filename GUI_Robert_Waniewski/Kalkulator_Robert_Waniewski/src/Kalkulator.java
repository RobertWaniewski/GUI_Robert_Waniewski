...
public class Kalkulator extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String tekst = "4";
        double wynik;
        double wartosc1 = Double.parseDouble(jTextField1.getText());
        double wartosc2 = Double.parseDouble(jTextField2.getText());
        
        if(jRadioButton1.isSelected()){wynik = wartosc1 + wartosc2;}
        else if(jRadioButton2.isSelected()){wynik = wartosc1 - wartosc2;}
        else if(jRadioButton3.isSelected()){wynik = wartosc1 * wartosc2;}
        else{wynik = wartosc1 / wartosc2;}
